...
import cashregister from "../../assets/cashregister.wav";
import groundhog2 from "../../assets/groundhog2.jpg";

export default st => html`
  <audio autoplay src="${cashregister}"></audio>
